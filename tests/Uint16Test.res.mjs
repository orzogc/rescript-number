...
var zero = $$Number.Uint16.zero;

var one = $$Number.Uint16.one;

var fromIntExn = $$Number.Uint16.fromIntExn;

var fromFloatExn = $$Number.Uint16.fromFloatExn;
...
function testFn(fn) {
  ...
  TestUtils.loop100Fn(function () {
        fn(TestUtils.randomInt(0, 65535));
      });
}
...
Ava("test " + name + " from int", (function (t) {
        ...
        var testOutOfRange = function (i, value) {
          ...
          t.deepEqual($$Number.Uint16.fromIntClamped(i), fromIntExn(value), undefined);
        };
        testOutOfRange(-1, 0);
        ...
        TestUtils.loop100Fn(function () {
              testOutOfRange(randomLargerInt(), 65535);
            });
        TestUtils.loop100Fn(function () {
...
Ava("test " + name + " to int", (function (t) {
        var testToInt = function (i) {
          var n = fromIntExn(i);
          var i$1 = i | 0;
          t.deepEqual($$Number.Uint16.toInt(n), i$1, undefined);
          t.deepEqual($$Number.Uint16.toIntExn(n), i$1, undefined);
          t.deepEqual($$Number.Uint16.toIntClamped(n), i$1, undefined);
          t.deepEqual($$Number.Uint16.toIntUnsafe(n), i$1, undefined);
        };
        testFn(testToInt);
      }));
...
Ava("test " + name + " from float", (function (t) {
        ...
        var testOutOfRange = function (f, value) {
          ...
          t.deepEqual($$Number.Uint16.fromFloatClamped(f), fromIntExn(value), undefined);
        };
...
Ava("test " + name + " to float", (function (t) {
        var testToFloat = function (i) {
          t.deepEqual($$Number.Uint16.toFloat(fromFloatExn(i)), i, undefined);
        };
        testToFloat(10000);
        TestUtils.loop100Fn(function () {
...
Ava("test " + name + " from string", (function (t) {
        var testInRange = function (i, s) {
          ...
          for(var radix = 2; radix <= 36; ++radix){
            ...
            t.deepEqual($$Number.Uint16.fromStringWithRadix(s$1, radix), Caml_option.some(n), undefined);
            t.deepEqual($$Number.Uint16.fromStringWithRadixExn(s$1, radix), n, undefined);
          }
          TestUtils.assertInvalidArgument(t, (function () {
                  return $$Number.Uint16.fromStringWithRadixExn(s, 1);
                }));
          TestUtils.assertInvalidArgument(t, (function () {
                  return $$Number.Uint16.fromStringWithRadixExn(s, 37);
                }));
        };
        testInRange(0, "0");
        testInRange(0, "-0");
        ...
        var testOutOfRange = function (f) {
          ...
          for(var radix = 2; radix <= 36; ++radix){
            ...
            t.deepEqual($$Number.Uint16.fromStringWithRadix(s$1, radix), undefined, undefined);
            TestUtils.assertOverflow(t, (function(radix,s$1){
                return function () {
                  return $$Number.Uint16.fromStringWithRadixExn(s$1, radix);
                }
                }(radix,s$1)));
          }
          TestUtils.assertInvalidArgument(t, (function () {
        ...
        var testIsNotInteger = function (s) {
          ...
          for(var radix = 2; radix <= 10; ++radix){
            t.deepEqual($$Number.Uint16.fromStringWithRadix(s, radix), undefined, undefined);
            TestUtils.assertInvalidArgument(t, (function(radix){
                return function () {
                  return $$Number.Uint16.fromStringWithRadixExn(s, radix);
                }
                }(radix)));
          }
          TestUtils.assertInvalidArgument(t, (function () {
...
Ava("test " + name + " to string", (function (t) {
        var testToString = function (i) {
          var s = String(i);
          var n = fromIntExn(i);
          t.deepEqual($$Number.Uint16.toString(n), s, undefined);
          for(var radix = 2; radix <= 36; ++radix){
            var s$1 = i.toString(radix);
            t.deepEqual($$Number.Uint16.toStringWithRadixExn(n, radix), s$1, undefined);
          }
          t.throws((function () {
                  return $$Number.Uint16.toStringWithRadixExn(n, 1);
                }), undefined, undefined);
          t.throws((function () {
                  return $$Number.Uint16.toStringWithRadixExn(n, 37);
                }), undefined, undefined);
        };
        testFn(testToString);
        var testToExponential = function (i) {
          ...
          var n = fromIntExn(i);
          t.deepEqual($$Number.Uint16.toExponential(n), s, undefined);
          for(var digits = 0; digits <= 100; ++digits){
            var s$1 = i.toExponential(digits);
            t.deepEqual($$Number.Uint16.toExponentialWithPrecisionExn(n, digits), s$1, undefined);
          }
          t.throws((function () {
                  return $$Number.Uint16.toExponentialWithPrecisionExn(n, -1);
                }), undefined, undefined);
          t.throws((function () {
                  return $$Number.Uint16.toExponentialWithPrecisionExn(n, 101);
                }), undefined, undefined);
        };
        ...
        var testToPrecision = function (i) {
          var s = i.toPrecision();
          var n = fromIntExn(i);
          t.deepEqual($$Number.Uint16.toPrecision(n), s, undefined);
          for(var digits = 1; digits <= 100; ++digits){
            var s$1 = i.toPrecision(digits);
            t.deepEqual($$Number.Uint16.toPrecisionWithPrecisionExn(n, digits), s$1, undefined);
          }
          t.throws((function () {
                  return $$Number.Uint16.toPrecisionWithPrecisionExn(n, 0);
                }), undefined, undefined);
          t.throws((function () {
                  return $$Number.Uint16.toPrecisionWithPrecisionExn(n, 101);
                }), undefined, undefined);
        };
...
Ava("test " + name + " range", (function (t) {
        t.deepEqual($$Number.Uint16.minValue, fromIntExn(0), undefined);
        t.deepEqual($$Number.Uint16.minValue, fromFloatExn(0), undefined);
        t.deepEqual($$Number.Uint16.maxValue, fromIntExn(65535), undefined);
        t.deepEqual($$Number.Uint16.maxValue, fromFloatExn(65535), undefined);
      }));
...
Ava("test " + name + " comparison", (function (t) {
        ...
        t.true($$Number.Uint16.eq(zero, negZero$1), undefined);
        t.true($$Number.Uint16.le(zero, negZero$1), undefined);
        t.true($$Number.Uint16.ge(zero, negZero$1), undefined);
        t.false($$Number.Uint16.lt(zero, negZero$1), undefined);
        t.false($$Number.Uint16.gt(zero, negZero$1), undefined);
...
Ava("test " + name + " addition", (function (t) {
        var testInRange = function (a, b) {
          ...
          t.deepEqual($$Number.Uint16.add(a$1, zero), Caml_option.some(a$1), undefined);
          t.deepEqual($$Number.Uint16.add(a$1, zero), $$Number.Uint16.add(zero, a$1), undefined);
          t.deepEqual($$Number.Uint16.addExn(a$1, zero), a$1, undefined);
          t.deepEqual($$Number.Uint16.addExn(a$1, zero), $$Number.Uint16.addExn(zero, a$1), undefined);
          t.deepEqual($$Number.Uint16.addClamped(a$1, zero), a$1, undefined);
          t.deepEqual($$Number.Uint16.addClamped(a$1, zero), $$Number.Uint16.addClamped(zero, a$1), undefined);
          t.deepEqual($$Number.Uint16.addUnsafe(a$1, zero), a$1, undefined);
          t.deepEqual($$Number.Uint16.addUnsafe(a$1, zero), $$Number.Uint16.addUnsafe(zero, a$1), undefined);
          t.deepEqual($$Number.Uint16.add(b$1, zero), Caml_option.some(b$1), undefined);
          t.deepEqual($$Number.Uint16.add(b$1, zero), $$Number.Uint16.add(zero, b$1), undefined);
          t.deepEqual($$Number.Uint16.addExn(b$1, zero), b$1, undefined);
          t.deepEqual($$Number.Uint16.addExn(b$1, zero), $$Number.Uint16.addExn(zero, b$1), undefined);
          t.deepEqual($$Number.Uint16.addClamped(b$1, zero), b$1, undefined);
          t.deepEqual($$Number.Uint16.addClamped(b$1, zero), $$Number.Uint16.addClamped(zero, b$1), undefined);
          t.deepEqual($$Number.Uint16.addUnsafe(b$1, zero), b$1, undefined);
          t.deepEqual($$Number.Uint16.addUnsafe(b$1, zero), $$Number.Uint16.addUnsafe(zero, b$1), undefined);
        };
        testInRange(73, 382);
        testInRange(0, 0);
        testInRange(65535, 0);
...
Ava("test " + name + " subtraction", (function (t) {
        var testInRange = function (a, b) {
          ...
          t.deepEqual($$Number.Uint16.sub(a$1, a$1), Caml_option.some(zero), undefined);
          t.deepEqual($$Number.Uint16.subExn(a$1, a$1), zero, undefined);
          t.deepEqual($$Number.Uint16.subClamped(a$1, a$1), zero, undefined);
          t.deepEqual($$Number.Uint16.subUnsafe(a$1, a$1), zero, undefined);
          t.deepEqual($$Number.Uint16.sub(a$1, zero), Caml_option.some(a$1), undefined);
          t.deepEqual($$Number.Uint16.subExn(a$1, zero), a$1, undefined);
          t.deepEqual($$Number.Uint16.subClamped(a$1, zero), a$1, undefined);
          t.deepEqual($$Number.Uint16.subUnsafe(a$1, zero), a$1, undefined);
          t.deepEqual($$Number.Uint16.sub(b$1, b$1), Caml_option.some(zero), undefined);
          t.deepEqual($$Number.Uint16.subExn(b$1, b$1), zero, undefined);
          t.deepEqual($$Number.Uint16.subClamped(b$1, b$1), zero, undefined);
          t.deepEqual($$Number.Uint16.subUnsafe(b$1, b$1), zero, undefined);
          t.deepEqual($$Number.Uint16.sub(b$1, zero), Caml_option.some(b$1), undefined);
          t.deepEqual($$Number.Uint16.subExn(b$1, zero), b$1, undefined);
          t.deepEqual($$Number.Uint16.subClamped(b$1, zero), b$1, undefined);
          t.deepEqual($$Number.Uint16.subUnsafe(b$1, zero), b$1, undefined);
        };
        testInRange(382, 73);
        testInRange(0, 0);
        testInRange(65535, 0);
        ...
        var testOutOfRange = function (a, b, value) {
          ...
          t.deepEqual($$Number.Uint16.subClamped(a$1, b$1), fromIntExn(value), undefined);
        };
...
Ava("test " + name + " multiplication", (function (t) {
        var testInRange = function (a, b) {
          ...
          t.deepEqual($$Number.Uint16.mul(a$1, zero), Caml_option.some(zero), undefined);
          t.deepEqual($$Number.Uint16.mul(a$1, zero), $$Number.Uint16.mul(zero, a$1), undefined);
          t.deepEqual($$Number.Uint16.mulExn(a$1, zero), zero, undefined);
          t.deepEqual($$Number.Uint16.mulExn(a$1, zero), $$Number.Uint16.mulExn(zero, a$1), undefined);
          t.deepEqual($$Number.Uint16.mulClamped(a$1, zero), zero, undefined);
          t.deepEqual($$Number.Uint16.mulClamped(a$1, zero), $$Number.Uint16.mulClamped(zero, a$1), undefined);
          t.deepEqual($$Number.Uint16.mulUnsafe(a$1, zero), zero, undefined);
          t.deepEqual($$Number.Uint16.mulUnsafe(a$1, zero), $$Number.Uint16.mulUnsafe(zero, a$1), undefined);
          t.deepEqual($$Number.Uint16.mul(a$1, one), Caml_option.some(a$1), undefined);
          t.deepEqual($$Number.Uint16.mul(a$1, one), $$Number.Uint16.mul(one, a$1), undefined);
          t.deepEqual($$Number.Uint16.mulExn(a$1, one), a$1, undefined);
          t.deepEqual($$Number.Uint16.mulExn(a$1, one), $$Number.Uint16.mulExn(one, a$1), undefined);
          t.deepEqual($$Number.Uint16.mulClamped(a$1, one), a$1, undefined);
          t.deepEqual($$Number.Uint16.mulClamped(a$1, one), $$Number.Uint16.mulClamped(one, a$1), undefined);
          t.deepEqual($$Number.Uint16.mulUnsafe(a$1, one), a$1, undefined);
          t.deepEqual($$Number.Uint16.mulUnsafe(a$1, one), $$Number.Uint16.mulUnsafe(one, a$1), undefined);
          t.deepEqual($$Number.Uint16.mul(b$1, zero), Caml_option.some(zero), undefined);
          t.deepEqual($$Number.Uint16.mul(b$1, zero), $$Number.Uint16.mul(zero, b$1), undefined);
          t.deepEqual($$Number.Uint16.mulExn(b$1, zero), zero, undefined);
          t.deepEqual($$Number.Uint16.mulExn(b$1, zero), $$Number.Uint16.mulExn(zero, b$1), undefined);
          t.deepEqual($$Number.Uint16.mulClamped(b$1, zero), zero, undefined);
          t.deepEqual($$Number.Uint16.mulClamped(b$1, zero), $$Number.Uint16.mulClamped(zero, b$1), undefined);
          t.deepEqual($$Number.Uint16.mulUnsafe(b$1, zero), zero, undefined);
          t.deepEqual($$Number.Uint16.mulUnsafe(b$1, zero), $$Number.Uint16.mulUnsafe(zero, b$1), undefined);
          t.deepEqual($$Number.Uint16.mul(b$1, one), Caml_option.some(b$1), undefined);
          t.deepEqual($$Number.Uint16.mul(b$1, one), $$Number.Uint16.mul(one, b$1), undefined);
          t.deepEqual($$Number.Uint16.mulExn(b$1, one), b$1, undefined);
          t.deepEqual($$Number.Uint16.mulExn(b$1, one), $$Number.Uint16.mulExn(one, b$1), undefined);
          t.deepEqual($$Number.Uint16.mulClamped(b$1, one), b$1, undefined);
          t.deepEqual($$Number.Uint16.mulClamped(b$1, one), $$Number.Uint16.mulClamped(one, b$1), undefined);
          t.deepEqual($$Number.Uint16.mulUnsafe(b$1, one), b$1, undefined);
          t.deepEqual($$Number.Uint16.mulUnsafe(b$1, one), $$Number.Uint16.mulUnsafe(one, b$1), undefined);
        };
        testInRange(73, 382);
        testInRange(0, 0);
        testInRange(65535, 0);
...
Ava("test " + name + " division", (function (t) {
        var testNotDividedByZero = function (a, b) {
          if (a !== 0) {
            ...
            t.deepEqual($$Number.Uint16.div(a$1, a$1), Caml_option.some(one), undefined);
            t.deepEqual($$Number.Uint16.divExn(a$1, a$1), one, undefined);
            t.deepEqual($$Number.Uint16.divUnsafe(a$1, a$1), one, undefined);
            t.deepEqual($$Number.Uint16.div(zero, a$1), Caml_option.some(zero), undefined);
            t.deepEqual($$Number.Uint16.divExn(zero, a$1), zero, undefined);
            t.deepEqual($$Number.Uint16.divUnsafe(zero, a$1), zero, undefined);
          }
          if (b !== 0) {
            ...
            t.deepEqual($$Number.Uint16.div(b$2, b$2), Caml_option.some(one), undefined);
            t.deepEqual($$Number.Uint16.divExn(b$2, b$2), one, undefined);
            t.deepEqual($$Number.Uint16.divUnsafe(b$2, b$2), one, undefined);
            t.deepEqual($$Number.Uint16.div(zero, b$2), Caml_option.some(zero), undefined);
            t.deepEqual($$Number.Uint16.divExn(zero, b$2), zero, undefined);
            t.deepEqual($$Number.Uint16.divUnsafe(zero, b$2), zero, undefined);
          }
          var a$3 = fromIntExn(a);
          var b$3 = fromIntExn(b);
          t.deepEqual($$Number.Uint16.div(a$3, one), Caml_option.some(a$3), undefined);
          t.deepEqual($$Number.Uint16.divExn(a$3, one), a$3, undefined);
          t.deepEqual($$Number.Uint16.divUnsafe(a$3, one), a$3, undefined);
          t.deepEqual($$Number.Uint16.div(b$3, one), Caml_option.some(b$3), undefined);
          t.deepEqual($$Number.Uint16.divExn(b$3, one), b$3, undefined);
          t.deepEqual($$Number.Uint16.divUnsafe(b$3, one), b$3, undefined);
        };
        ...
        var testDividedByZero = function (i) {
          var a = fromIntExn(i);
          t.deepEqual($$Number.Uint16.div(a, zero), undefined, undefined);
          TestUtils.assertDivisionByZero(t, (function () {
                  return $$Number.Uint16.divExn(a, zero);
                }));
          var negZero$1 = fromIntExn(negZero);
          t.deepEqual($$Number.Uint16.div(a, negZero$1), undefined, undefined);
          TestUtils.assertDivisionByZero(t, (function () {
                  return $$Number.Uint16.divExn(a, negZero$1);
                }));
        };
...
Ava("test " + name + " remainder", (function (t) {
        var testNotModByZero = function (a, b) {
          if (a !== 0) {
            ...
            t.deepEqual($$Number.Uint16.rem(zero, a$1), Caml_option.some(zero), undefined);
            t.deepEqual($$Number.Uint16.remExn(zero, a$1), zero, undefined);
            t.deepEqual($$Number.Uint16.remUnsafe(zero, a$1), zero, undefined);
          }
          if (b !== 0) {
            ...
            t.deepEqual($$Number.Uint16.rem(zero, b$2), Caml_option.some(zero), undefined);
            t.deepEqual($$Number.Uint16.remExn(zero, b$2), zero, undefined);
            t.deepEqual($$Number.Uint16.remUnsafe(zero, b$2), zero, undefined);
          }
          var a$3 = fromIntExn(a);
          var b$3 = fromIntExn(b);
          t.deepEqual($$Number.Uint16.rem(a$3, one), Caml_option.some(zero), undefined);
          t.deepEqual($$Number.Uint16.remExn(a$3, one), zero, undefined);
          t.deepEqual($$Number.Uint16.remUnsafe(a$3, one), zero, undefined);
          t.deepEqual($$Number.Uint16.rem(b$3, one), Caml_option.some(zero), undefined);
          t.deepEqual($$Number.Uint16.remExn(b$3, one), zero, undefined);
          t.deepEqual($$Number.Uint16.remUnsafe(b$3, one), zero, undefined);
        };
        ...
        var testModByZero = function (a) {
          var a$1 = fromIntExn(a);
          t.deepEqual($$Number.Uint16.rem(a$1, zero), undefined, undefined);
          TestUtils.assertDivisionByZero(t, (function () {
                  return $$Number.Uint16.remExn(a$1, zero);
                }));
          var negZero$1 = fromIntExn(negZero);
          t.deepEqual($$Number.Uint16.rem(a$1, negZero$1), undefined, undefined);
          TestUtils.assertDivisionByZero(t, (function () {
                  return $$Number.Uint16.remExn(a$1, negZero$1);
                }));
        };
...
Ava("test " + name + " bitwise", (function (t) {
        ...
        var assertAnd = function (a, b, value) {
          ...
          t.deepEqual($$Number.Uint16.land(a$1, $$Number.Uint16.lnot(a$1)), zero, undefined);
          t.deepEqual($$Number.Uint16.land(b$1, $$Number.Uint16.lnot(b$1)), zero, undefined);
          t.deepEqual($$Number.Uint16.land(value$1, $$Number.Uint16.lnot(value$1)), zero, undefined);
        ...
        var assertXor = function (a, b, value) {
          ...
          var value$1 = fromIntExn(value);
          var oneBits = $$Number.Uint16.maxValue;
          t.deepEqual($$Number.Uint16.lxor(a$1, a$1), zero, undefined);
          t.deepEqual($$Number.Uint16.lxor(b$1, b$1), zero, undefined);
          t.deepEqual($$Number.Uint16.lxor(value$1, value$1), zero, undefined);
        ...
        var value = fromIntExn(10000);
        for(var i = -16; i <= 32; ++i){
          t.deepEqual($$Number.Uint16.lsl(value, i), fromIntExn(Belt_Array.getExn(valueShiftLeft, modBits(i))), undefined);
        }
        var mask = 65535;
        var testUnsignedShiftRight = function (value) {
          ...
          for(var i = -16; i <= 32; ++i){
            var i_ = modBits(i);
            t.deepEqual($$Number.Uint16.lsr(n, i), fromFloatExn(Math.floor((
        ...
        var testShiftRight = function (value) {
          var n = fromIntExn(value);
          for(var i = -16; i <= 32; ++i){
            t.deepEqual($$Number.Uint16.asr(n, i), fromFloatExn(Math.floor(value / Math.pow(2.0, modBits(i)))), undefined);
          }
        };
        ...
        for(var i$1 = -16; i$1 <= 32; ++i$1){
          t.deepEqual($$Number.Uint16.rsl(value$1, i$1), fromIntExn(Belt_Array.getExn(valueRotateShiftLeft, modBits(i$1))), undefined);
        }
...
Ava("test " + name + " integer math", (function (t) {
        ...
        for(var i = 0; i <= 15; ++i){
          testClz($$Number.Uint16.lsl(one, i), (16 - i | 0) - 1 | 0);
        }
        t.deepEqual($$Number.Uint16.imul(fromIntExn(73), fromIntExn(382)), fromIntExn(27886), undefined);
        var mask = 65535;
        ...
        TestUtils.loop100Fn(function () {
              ...
              t.deepEqual($$Number.Uint16.imul(fromIntExn(a), fromIntExn(b)), fromFloatExn(result), undefined);
              t.deepEqual($$Number.Uint16.imul(fromIntExn(b), fromIntExn(a)), fromFloatExn(result), undefined);
            });
        var testPowInRange = function (a, b) {
          ...
          t.deepEqual($$Number.Uint16.pow(a$1, zero), Caml_option.some(one), undefined);
          t.deepEqual($$Number.Uint16.powExn(a$1, zero), one, undefined);
          t.deepEqual($$Number.Uint16.powUnsafe(a$1, zero), one, undefined);
          t.deepEqual($$Number.Uint16.pow(b$1, zero), Caml_option.some(one), undefined);
          t.deepEqual($$Number.Uint16.powExn(b$1, zero), one, undefined);
          t.deepEqual($$Number.Uint16.powUnsafe(b$1, zero), one, undefined);
          t.deepEqual($$Number.Uint16.pow(a$1, one), Caml_option.some(a$1), undefined);
          t.deepEqual($$Number.Uint16.powExn(a$1, one), a$1, undefined);
          t.deepEqual($$Number.Uint16.powUnsafe(a$1, one), a$1, undefined);
          t.deepEqual($$Number.Uint16.pow(b$1, one), Caml_option.some(b$1), undefined);
          t.deepEqual($$Number.Uint16.powExn(b$1, one), b$1, undefined);
          t.deepEqual($$Number.Uint16.powUnsafe(b$1, one), b$1, undefined);
        };
        testPowInRange(0, 1);
        testPowInRange(1, 0);
